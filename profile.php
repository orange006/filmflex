...
<div class="settingsContainer column">
    <div class="formSection">
        <form method="POST">
            <div class="usernameInfo"><?php echo $user->getUsername(); ?></div>
    ...
    <div class="formSection">
        ...
        if($user->getIsSubscribed()) {
            echo "<h3>You are subscribed! Go to <a href='https://www.paypal.com/'>PayPal</a> to cancel.</h3>";
        }
        else {
            echo "<a href='billing.php'>Subscribe to Filmflex.</a>";
        }
        ?>
    </div>
</div>
